  ...
  return (
    <>
      <div className="flex px-6 justify-between items-center">
        <div className="bg-gray-300 px-4 py-1.5 flex items-center justify-between gap-x-2 rounded-full w-[75%]">
        ...
        <div className="flex justify-between items-center w-[25%] text-sm px-6">
          ...
          <button className="border border-gray-500 p-1.5 rounded-lg text-gray-700 font-medium shadow-2xl">Submit An Image</button>
        </div>
      </div>
